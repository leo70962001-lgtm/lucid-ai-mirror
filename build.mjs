...
const MODULES = ['js/i18n.js', 'js/products.js', 'js/context.js', 'js/analysis.js', 'js/season.js', 'js/lipcolor.js', 'js/trends.js', 'js/routine.js', 'js/learn.js', 'js/advisor.js', 'js/emoji.js', 'js/gender.js', 'js/chart.js', 'js/faceshape.js', 'js/face-mesh.js', 'js/makeup.js',
